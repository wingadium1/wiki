                ...
                template(v-slot:default='{ hover }')
                  v-card.radius-7.primary.animated.fadeInUp(
                    ...
                    v-card-text.text-center(@click='')
                      img(src='/wiki/_assets/svg/editor-icon-api.svg', alt='API', style='width: 36px; opacity: .5;')
              ...
              v-hover
                template(v-slot:default='{ hover }')
                  v-card.radius-7.primary.animated.fadeInUp.wait-p1s(
                    ...
                    v-card-text.text-center(@click='')
                      img(src='/wiki/_assets/svg/editor-icon-wikitext.svg', alt='WikiText', style='width: 36px; opacity: .5;')
            ...
            v-flex(xs4)
              v-card.radius-7.animated.fadeInUp.wait-p2s(
                ...
                v-card-text.text-center(@click='selectEditor("code")')
                  img(src='/wiki/_assets/svg/editor-icon-code.svg', alt='Code', style='width: 36px;')
            ...
            v-flex(xs4)
              v-card.radius-7.animated.fadeInUp.wait-p1s(
                ...
                v-card-text.text-center(@click='selectEditor("markdown")')
                  img(src='/wiki/_assets/svg/editor-icon-markdown.svg', alt='Markdown', style='width: 36px;')
              ...
              v-hover
                template(v-slot:default='{ hover }')
                  v-card.radius-7.primary.animated.fadeInUp.wait-p2s(
                    ...
                    v-card-text.text-center(@click='')
                      img(src='/wiki/_assets/svg/editor-icon-tabular.svg', alt='Tabular', style='width: 36px; opacity: .5;')
            ...
            v-flex(xs4)
              v-card.radius-7.animated.fadeInUp.wait-p3s(
                ...
                v-card-text.text-center(@click='selectEditor("ckeditor")')
                  img(src='/wiki/_assets/svg/editor-icon-ckeditor.svg', alt='Visual Editor', style='width: 36px;')
                ...
                template(v-slot:default='{ hover }')
                  v-card.radius-7.animated.fadeInUp(
                    ...
                    v-card-text.text-center(@click='fromTemplate')
                      img(src='/wiki/_assets/svg/icon-cube.svg', alt='From Template', style='width: 42px; opacity: .5;')
              ...
              v-hover
                template(v-slot:default='{ hover }')
                  v-card.radius-7.teal.animated.fadeInUp.wait-p1s(
                    ...
                    v-card-text.text-center(@click='')
                      img(src='/wiki/_assets/svg/icon-route.svg', alt='Redirection', style='width: 42px; opacity: .5;')
              ...
              v-hover
                template(v-slot:default='{ hover }')
                  v-card.radius-7.teal.animated.fadeInUp.wait-p2s(
                    ...
                    v-card-text.text-center(@click='')
                      img(src='/wiki/_assets/svg/icon-sewing-patch.svg', alt='Code', style='width: 42px; opacity: .5;')
