...
const graphQLEndpoint = window.location.protocol + '//' + window.location.host + '/wiki/graphql'
const graphQLWSEndpoint = ((window.location.protocol === 'https:') ? 'wss:' : 'ws:') + '//' + window.location.host + '/wiki/graphql-subscriptions'
